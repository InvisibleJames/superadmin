...
tbody tr:hover .med-td {
  background: rgba(255, 255, 255, 0.03);
}
tbody tr[data-selected='true'] .med-td {
  background: rgba(24, 199, 181, 0.1);
}
tbody tr[data-selected='true'] .med-td--check {
...
.med-pg--active {
  ...
  border-color: rgba(24, 199, 181, 0.4);
  color: var(--teal-300);
  font-weight: 600;
}
</style>
