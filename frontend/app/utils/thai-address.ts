/* ============================================================
   ...
   Bundled from the MedReco handoff assets:
     thai-districts.js  → province → districts (all 77 provinces)
     thai-tambon.js     → district → subdistricts (Bangkok complete,
                          sample tambon for major provinces)
   ============================================================ */

export const TH_DISTRICTS: Record<string, string[]> = {
...
export const TH_TAMBONS: Record<string, string[]> = {
...
/** All 77 provinces, sorted in Thai collation. */
export const TH_PROVINCES: string[] = Object.keys(TH_DISTRICTS).sort((a, b) => a.localeCompare(b, 'th'))

export function districtsOf(province: string): string[] {
  return TH_DISTRICTS[province] ?? []
}
export function subdistrictsOf(district: string): string[] {
  return TH_TAMBONS[district] ?? []
}
