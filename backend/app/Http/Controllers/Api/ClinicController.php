...
class ClinicController extends Controller
{
    ...
    {
        $query = Clinic::query()->withCount('branches');
    ...
    {
        return new ClinicResource($clinic->loadCount('branches'));
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return (new ClinicResource($clinic->loadCount('branches')))->response()->setStatusCode(201);
    }
